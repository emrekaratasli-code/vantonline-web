...
const translations = {
    ...
    checkout: {
        ...
        stepOtp: { tr: 'E-posta Doğrulama', en: 'Email Verification' },
    ...
    contact: {
        ...
        errorSubmit: { tr: 'Mesaj gönderilemedi. Lütfen tekrar deneyin.', en: 'Message could not be sent. Please try again.' },
